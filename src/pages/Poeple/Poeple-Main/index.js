        ...
        <>
            <div className="custom-main-content mt-2 pt-4">
                ...
                <div className="d-flex justify-content-between align-items-lg-center flex-lg-row flex-column">
                    ...
                    <div className="d-flex align-items-lg-end justify-content-between flex-lg-row flex-column gap-32 " >
                        <form className="d-flex justify-content-between align-items-sm-center flex-sm-row responsive-class-property gap-32">
                            <div>
                                <label className="custom-label-city mb-1" htmlFor="">Type</label>
                                <HomePageSelect myname="City" myclassName="custom-select-city">
                                    <option value="Barkely">All</option>
                                    <option value="Dubai">Single</option>
                                </HomePageSelect>
                            </div>
                            <div>
                        ...
                        <div className="d-flex justify-content-between align-items-sm-center flex-sm-row responsive-class-property gap-32">
                    ...
                    <table className="table custom-task-table mt-3 ">
                        <thead className="bg-transparent border-top-0">
                            <tr>
                                ...
                                <th scope="col" className='m-w-100px'>Job Title</th>
                                <th scope="col">Email</th>
                                <th scope="col">Phone</th>
                                <th scope="col">Pipeline</th>
                                <th scope="col" className='m-w-130px'>Last Update</th>
                                <th scope="col" className='m-w-180px'>Last date of Contact</th>
                            </tr>
                        </thead>
                        <tbody>
                            {allPoeple.map((data, index) => {
                                return (
                                    <tr key={index}>
                                        <td>
                                            <div className="home-checkbox1">
                                        ...
                                        <td>{data.email}</td>
                                        <td>{data.phone}</td>
                                        <td ><span className={`label-css ${data.pipeline === 'Marketing' ? 'marketing-pipline' :  'leads-pipline' }`}>
                                            {data.pipeline}
                                        </span></td>
